  ...
  describe('Footer verification', () => {
    ...
    describe('Verify Footer Navigation Components are present and Links are functional.', () => {
      ...
      it('Verify that Footer Navigation Component is present and Links are functional - Laybuy', () => {
        if ((variables.brand == 'boohoo.com' && (variables.locale == 'UK'|| variables.locale == 'AU'|| variables.locale == 'NZ' )) || (variables.brand == 'nastygal.com' && variables.locale != 'US') || variables.brand == 'coastfashion.com' || variables.brand == 'oasis-stores.com')
      ...
      it('Verify that Footer Navigation Component is present and Links are functional - Environmental & Social Responsibility', () => {
        ...
        } else if (variables.brand == 'coastfashion.com'|| variables.brand == 'nastygal.com' || variables.brand == 'wallis.co.uk'|| variables.brand == 'dorothyperkins.com' || variables.brand == 'burton.co.uk' || variables.brand == 'oasis-stores.com' || variables.brand == 'karenmillen.com') {
      ...
      it('Verify that Footer Navigation Component is present and Links are functional - Modern Slavery Statement', () => {
        if ((variables.brand == 'boohoo.com' && (variables.locale == 'UK' || variables.locale == 'NZ')) || (variables.brand == 'nastygal.com' && variables.locale == 'UK') || variables.brand == 'wallis.co.uk'|| variables.brand == 'dorothyperkins.com' || variables.brand == 'burton.co.uk' || variables.brand == 'coastfashion.com' || variables.brand == 'oasis-stores.com' || variables.brand == 'karenmillen.com')
