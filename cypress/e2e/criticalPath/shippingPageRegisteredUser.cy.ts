...
describe('Shipping Page Registered user tests', function () {
  ...
  it.only('Verify that PREMIER can be added to the cart', () => {    
    if (variables.brand == 'boohoo.com' && variables.locale == 'UK' || variables.locale == 'IE' || variables.locale == 'FR') {
    ...
    } else if (variables.brand == 'nastygal.com' || variables.brand == 'burton.co.uk'|| variables.brand == 'wallis.co.uk' || variables.brand == 'dorothyperkins.com' && variables.locale == 'UK' || variables.locale == 'IE') {
      shippingPage.click.addPremierByButtonName(assertionText.AddPremierToCartButton[variables.language]);
      shippingPage.assertions.assertCartShippingPageContainsProduct(assertionText.Premier[variables.language]);
    } else if (variables.brand == 'coastfashion.com') {
      shippingPage.click.addPremierByButtonName(assertionText.AddPremierToCartButton[variables.language]);
