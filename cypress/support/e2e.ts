...
beforeEach(() => {
  ...
  } else if((variables.brand == 'coastfashion.com' || variables.brand == 'oasis-stores.com' || variables.brand == 'karenmillen.com' || variables.brand == 'warehousefashion.com') && variables.locale == 'EU'){
