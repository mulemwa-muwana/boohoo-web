...
describe('Billing page functionality for registered user', function () {
  ...
  it('Verify that shipping method is displayed', function () {
    ...
    if (variables.brand== 'boohoo.com' || variables.brand == 'nastygal.com' || variables.brand == 'dorothyperkins.com' || variables.brand == 'oasis-stores.com'|| variables.brand == 'wallis.co.uk') {
