  ...
  describe('Footer verification', () => {
    ...
    describe('Verify Footer Navigation Components are present and Links are functional.', () => {
      ...
      it('Verify that Footer Navigation Component is present and Links are functional - Become an Affiliate', function () {
        if (variables.brand == 'boohoo.com' || (variables.brand == 'nastygal.com' && variables.locale == 'UK') || (variables.brand == 'coastfashion.com' && variables.locale != 'IE') || variables.brand == 'karenmillen.com' || variables.brand == 'misspap.com' || variables.brand == 'boohooman.com') {
